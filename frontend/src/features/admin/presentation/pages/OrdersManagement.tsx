...
const ORDER_STATUSES: OrderModel["status"][] = [
  "Pending",
  "Processing",
  "Shipped",
  "Delivered",
...
const OrdersManagement = () => {
  ...
  const handleStatusChange = async (
    ...
    try {
      ...
      await dispatch(
        OrdersService.updateOrderStatus({ orderId, status: newStatus }),
      ).unwrap();
      toast.success(
      ...
      toast.error(
        `Failed to update status: ${updateError?.message || "Unknown error"}`,
      );
    } finally {
