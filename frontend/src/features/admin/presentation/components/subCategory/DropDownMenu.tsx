      ...
      >
        ...
        >
          <path
            ...
            d={
              isOpen
                ? "M14.77 12.79a.75.75 0 01-1.06 0L10 9.06l-3.71 3.71a.75.75 0 01-1.06-1.06l4.25-4.25a.75.75 0 011.06 0l4.25 4.25a.75.75 0 010 1.06z"
                : "M5.23 7.21a.75.75 0 011.06 0L10 10.94l3.71-3.73a.75.75 0 111.06 1.06l-4.25 4.25a.75.75 0 01-1.06 0L5.23 8.27a.75.75 0 010-1.06z"
            }
            clipRule="evenodd"
          />
        </svg>
...
const DropDownMenu: React.FC<DropDownMenuProps> = ({
  ...
  return (
    <div className="p-4 max-w-md mx-auto" dir="rtl">
      <Dropdown options={categoriesNames} onSelect={handleSelect} />
    </div>
  );
};
