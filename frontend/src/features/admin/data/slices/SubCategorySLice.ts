...
export const subCategorySlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(
        SubCategoriesService.fetchAllSubCategories.fulfilled,
        (state, action) => {
          state.loading = false;
      ...
      .addCase(
        SubCategoriesService.fetchAllSubCategories.rejected,
        (state, action) => {
          state.loading = false;
      ...
      .addCase(
        SubCategoriesService.createSubCategory.fulfilled,
        (state, action) => {
          state.loading = false;
      ...
      .addCase(
        SubCategoriesService.createSubCategory.rejected,
        (state, action) => {
          state.loading = false;
          state.error = action.payload as string; // Set error message
        },
      ...
      .addCase(
        SubCategoriesService.updateSubCategory.fulfilled,
        (state, action) => {
          state.loading = false;
          // Update the subcategory in the list
          const updatedSubCategory = action.payload.data;
          state.subCategoriesList = state.subCategoriesList.map(
            (subCategory) => {
              return subCategory._id === updatedSubCategory._id
                ? updatedSubCategory
                : subCategory;
            },
          );
      ...
      .addCase(
        SubCategoriesService.updateSubCategory.rejected,
        (state, action) => {
          state.loading = false;
          state.error = action.payload as string; // Set error message
        },
      ...
      .addCase(
        SubCategoriesService.deleteSubCategory.fulfilled,
        (state, action) => {
          state.loading = false;
      ...
      .addCase(
        SubCategoriesService.deleteSubCategory.rejected,
        (state, action) => {
          state.loading = false;
          state.error = action.payload as string; // Set error message
        },
