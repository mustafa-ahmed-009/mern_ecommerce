...
const FeaturedProducts: React.FC = () => {
  ...
  if (loading && productsList.length === 0) { // Show loading only on initial load
    return (
  ...
  if (!loading && featured.length === 0) {
    return <p className="text-center text-gray-500 my-4">No featured products available at the moment.</p>;
  }
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6 my-6">
